...
module BoxGrinder
  AWS_DEFAULTS = {
          ...
          :kernel_id      => {'fedora' => {'12'=> { "i386" => "aki-7d47a814", "x86_64" => "aki-7547a81c" } } },
          :ramdisk_id     => {'fedora' => {'12'=> { "i386" => "ari-7f47a816", "x86_64" => "ari-7747a81e" } } },

          #{ "i386" => "aki-a71cf9ce", "x86_64" => "aki-b51cf9dc" }, # EU: :kernel_id => { "i386" => "aki-61022915", "x86_64" => "aki-6d022919" },
